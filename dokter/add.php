...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO pasien (nama, gender, tmp_lahir, tgl_lahir, kategori, telepon, alamat, unit_kerja_id) VALUES (?,? ,? ,? ,? ,? ,? ,?)";
    $stmt = $dbh->prepare($sql);
    $stmt->execute(array($_nama, $_gender, $_tmp_lahir, $_tgl_lahir, $_kategori, $_telepon, $_alamat, $_unit_kerja_id));
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="add.php" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="gender" class="col-4 col-form-label">Kategori</label>
                                    <div class="col-8">
                                    <input id="kategori" name="kategori" type="kategori" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="email" class="col-4 col-form-label">Telepon</label>
                                    <div class="col-8">
                                        <input id="telepon" name="telepon" type="telepon" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
